...
function Fill(lowerNum, upperNum) {
  const returnValue = []
  while (lowerNum <= upperNum) {
    returnValue.push(lowerNum)
    lowerNum++
  }
  return returnValue
}
...
function Exclaim(string, number) {
  let returnValue = string.toUpperCase()
